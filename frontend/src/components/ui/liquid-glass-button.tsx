...
/** Render this once anywhere in the component tree that uses the glass effect.
 *  `filterId` defaults to "container-glass" so it matches the LiquidButton default.
 *  Pass a custom id (e.g. "composer-glass") when embedding more than once. */
export function GlassFilter({ filterId = "container-glass" }: { filterId?: string }) {
  return (
