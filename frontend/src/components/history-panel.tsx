        ...
        <div className="px-4 py-2 shrink-0" style={{ borderBottom: "1px solid rgba(255,255,255,0.08)" }}>
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-lg pl-8 pr-3 py-1.5 text-xs text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30 transition-colors"
              style={{
              ...
              {filteredSessions.map((session) => (
                <li key={session.id}>
                  <div
                    ...
                    className="w-full text-left px-4 py-3 hover:bg-accent transition-colors group relative cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30"
